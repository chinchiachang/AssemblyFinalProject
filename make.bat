...
setlocal 
set INCLUDE=C:\Users\test\Google Drive\Cloud\106_1\Assembly_Language\folder\WINdbgFolder;	
set LIB=C:\Users\test\Google Drive\Cloud\106_1\Assembly_Language\folder\WINdbgFolder;
set PATH=C:\Users\test\Google Drive\Cloud\106_1\Assembly_Language\folder\WINdbgFolder;
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:Final.exe Final.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
